...
<body>
<center>
<input type="button" value="내 정보 보기" onclick="location.href='MyInfoCtrl.do'">
<h2> 전체 글 보기</h2>
<c:set var="id" value="${id }"/>
<c:if test="${id==null }">
	<input type="button" value="로그인" onclick="location.href='Login.jsp'"> GUEST 님 환영합니다!
</c:if>

<c:if test="${id!=null }">
	<input type="button" value="로그아웃" onclick="location.href='Logout.jsp'"> ${id } 님 환영합니다!
	<table width=700 border=1>
	<tr height=50>
		<td align="right" colspan="5"><button onclick="location.href='BoardWriteCtrl.do'">글 쓰기</button>
	</tr>
	<tr height=50>
